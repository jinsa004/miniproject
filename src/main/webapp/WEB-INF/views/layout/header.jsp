                ...
                <header>
                    ...
                    <div class="login_box">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a class="btn_logout" href="/logout"
                                    >로그아웃</a
                                >
                    ...
                    <nav>
                        <ul>
                            ...
                            <li>
                                <a
                                    href="/emp/matchingNotice/${empprincipal.employeeId}"
                                    >매칭리스트</a
                                >
                            </li>
                            <li>
                                <a
                                    href="/emp/subscribeNotice/${empprincipal.employeeId}"
                                    >구독기업공고</a
                                >
                            </li>
                            <li>
