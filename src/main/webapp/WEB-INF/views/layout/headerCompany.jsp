    ...
    <body>
        <div id="user_wrap">
                ...
                <header>
                    ...
                    <nav>
                        <ul>
                            ...
                            <li>
                                <a
                                    href="/co/noticeSave/${coprincipal.companyId}"
                                    >공고등록</a
                                >
                            </li>
                            <li>
                                <a
                                    href="/co/noticeService/${coprincipal.companyId}"
                                    >공고/지원자관리</a
                                >
                            </li>
                            <li>
                                <a
                                    href="/co/matchingResume/${coprincipal.companyId}"
                                    >매칭리스트</a
                                >
                            </li>
                        </ul>
            ...
            <div
                ...
                onClick="javascript:popCloseCompany();"
            ></div>
