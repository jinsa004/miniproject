...
pageEncoding="UTF-8" %> <%@ include file="../layout/header.jsp" %>univ_
    ...
    <div class="container">
        <div class="recruit_detail_box cf">
            ...
            <div class="company_box rd_right">
                ...
                <span class="info_tit"
                    ><em>회사명</em
                    ><strong>${noticePS.introTitle}</strong></span
                >
                <span class="info_year"
                    ><em>설립연도</em
                    ><strong>${noticePS.introBirth}</strong></span
                >
                <span class="info_task"
                    ><em>주요업무</em
                    ><strong>${noticePS.introTask}</strong></span
                >
                <span class="info_ssar"
                    ><em>평균연봉</em
                    ><strong>${noticePS.introSal}</strong></span
                >
                <span class="info_benefit"
                    ><em>기업복지</em
                    ><strong>${noticePS.introWellfare}</strong></span
                >
                <div class="company_location">
                    <span
                        ><em>주소지</em
                        ><strong>${noticePS.introLocation}</strong></span
                    >
                    ...
                    <ul>
                        <c:forEach var="resumePS" items="${resumePS}">
                            <li class="resume_select_cont">
                                ...
                                >
                                    <span class="tit"
                                        >${resumePS.resumeTitle}</span
                                    >
                                    <span class="career"
                                        >${resumePS.careerPeriod}</span
                                    >
                                    <span class="part"
                                        >${resumePS.jobName}</span
                                    >
                                </label>
                            </li>
                            <!-- .resume_select_cont -->
