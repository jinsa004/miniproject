      ...
      <div class="container">
        <div class="tablist">
          <ul class="tabs">
            ...
            <li class="btn_tab" data-tab="tab-2"><a href="/emp/notice/search?jobCode=1">프론트엔드</a></li>
            <li class="btn_tab" data-tab="tab-3"><a href="/emp/notice/search?jobCode=2">백엔드</a></li>
            <li class="btn_tab" data-tab="tab-4"><a href="/emp/notice/search?jobCode=3">웹풀스택</a></li>
            <li class="btn_tab" data-tab="tab-5"><a href="/emp/notice/search?jobCode=4">안드로이드</a></li>
            <li class="btn_tab" data-tab="tab-6"><a href="/emp/notice/search?jobCode=5">IOS</a></li>
          </ul>
        </div>
        <!-- .tablist -->
