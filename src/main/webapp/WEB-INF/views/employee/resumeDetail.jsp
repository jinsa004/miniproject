      ...
      <div id="info" class="form">
        ...
        <div class="info_form">
          ...
          <dl class="info_basic">
            ...
            <dd id="info_email">hong@nate.com</dd>
            <br />
            <dt class="info_list_item">휴대폰</dt>
            <dd id="info_cell">010-0000-0000</dd>
            <br />
            <dt class="info_list_item">전화번호</dt>
            <dd id="info_tel">010-0000-0000</dd>
            <br />
        ...
        <div class="resume_edu">
          <div class="edu_select">
            <div class="btn-group">
              ...
              <button type="button" class="edu_btn" id="checked">
                대학.대학원 이상 졸업
              </button>
            </div>
          </div>
        ...
        <div class="resume_career">
          <div class="career_select">
            <div class="btn-group">
              ...
              <button type="button" class="career_btn" id="checked">
                경력
              </button>
            </div>
          </div>
