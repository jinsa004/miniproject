        ...
        <div class="recruit_detail_box cf">
          ...
          <div class="notice_box rd_left">
            <div class="notice_title">
              <h3>공고명</h3>
              <span class="notice_txt">프론트엔드 & 백엔드 개발자 채용 서버개발자 Server Developer</span>
            </div>
            <!-- .notice_title -->
            ...
            <div class="notice_task">
              <h3>주요업무</h3>
              <span class="notice_txt">사내 플랫폼과 외부 광고 플랫폼들이 제공하는 기능 및 데이터들을
                통합하고 사용성 개선</span>
            </div>
            <!-- .notice_task -->
            ...
            <div class="notice_benefit">
              <h3>복리후생</h3>
              <span class="notice_txt">4대 보험 적용, 각종 경조금 지원, 식대/교통비 지원, 성과금</span>
            </div>
            <!-- .notice_benefit -->
          ...
          <div class="company_box rd_right">
            ...
            <span class="info_year"><em>설립연도</em><strong>2022.10.07</strong></span>
            <span class="info_task"><em>주요업무</em><strong>서버관리 및 프로그램 설계</strong></span>
            <span class="info_ssar"><em>평균연봉</em><strong>4000</strong></span>
            <span class="info_benefit"><em>기업복지</em><strong>유연한 출퇴근, 4대보험, 성과금</strong></span>
