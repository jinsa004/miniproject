            ...
            <div id="tab-1" class="notice_inner notice_inner1 tab-content on">
              <div class="notice_ul_wrap">
                <c:forEach var="noticeList" items="${noticeList}">
                  <ul>
                    <li>
                      <a href="/cs/co/noticeService/${coprincipal.companyId}/noticeDetail/${noticeList.noticeId}"><img
                          src="/img/logo_1.png" alt="logo" /></a>
                    </li>
                    <li>
                      <a href="/cs/co/noticeService/${coprincipal.companyId}/noticeDetail/${noticeList.noticeId}">${noticeList.noticeTitle}
