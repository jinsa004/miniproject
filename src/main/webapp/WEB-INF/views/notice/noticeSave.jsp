                            ...
                            <div id="field" class="form">
                              ...
                              <div class="resume_field info_form3">
                                ...
                                <div class="input_radio_skill">
                                  <ul>
                                    <li>
                                      <input type="radio" name="part_select" id="part_select_front" class="noticeQual"
                                        value="프론트엔드" />
                                      <label for="part_select_front"><em>프론트엔드</em></label>
                                    </li>
                                    <li>
                                      <input type="radio" name="part_select" id="part_select_back" class="noticeQual"
                                        value="백엔드" checked />
                                      <label for="part_select_back"><em>백엔드</em></label>
                                    </li>
                                    <li>
                                      <input type="radio" name="part_select" id="part_select_full" class="noticeQual"
                                        value="풀스택" />
                                      <label for="part_select_full"><em>풀스택</em></label>
                                    </li>
                                    <li>
                                      <input type="radio" name="part_select" id="part_select_and" class="noticeQual"
                                        value="안드로이드" />
                                      <label for="part_select_and"><em>안드로이드</em></label>
                                    </li>
                                    <li>
                                      <input type="radio" name="part_select" id="part_select_ios" class="noticeQual"
                                        value="ios" />
                              ...
                              <div class="btn_co_recruit_insert2">
                                <button type="button" class="btn_recruit_insert2" id="btnInsertNotice">공고등록</button>
